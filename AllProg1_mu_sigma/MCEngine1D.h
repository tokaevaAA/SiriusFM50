...
template 
<typename Diffusion1D, typename AProvider, typename BProvider, typename AssetClassA, typename AssetClassB>
class MCEngine1D{
  private:
    long m_L; //Actual L, <=MaxL
    long m_P; //Actual P, may be >> MaxPM
    long const m_MaxL;
    long const m_MaxP;
